...
Cursor speaks MCP over streamable HTTP, so her server plugs in with a single URL. Once connected, Cursor's agent can list your channels, schedule posts and pull analytics without leaving the editor.
