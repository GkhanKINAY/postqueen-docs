...
Point a client at one URL and your agent gets **14 tools** it can call. It reads their schemas, then calls them on your behalf.
...
| `schedulePostTool` | Schedule, draft, or immediately publish posts. The wire name is `schedulePostTool`, not a class name |
...
<Steps>
  ...
  <Step title="Schedule the post">
    The agent calls `schedulePostTool` to schedule your post in the correct format.
  </Step>
</Steps>
