...
Two things follow from that. It can write to your calendar, so treat it with the same care as `schedulePost`. And because she plans the steps herself, you get less control over exactly which tools run than you would calling them directly.
