...
<Tabs>
  ...
  <Tab title="Claude, ChatGPT and Grok">
    ...
    Claude: **Settings → Connectors → Add custom connector**. ChatGPT: **Settings → Security and login → Developer mode**, then **Plugins / +**. Grok: [grok.com/connectors](https://grok.com/connectors) → Custom.
