...
<Tabs>
  ...
  <Tab title="Claude, ChatGPT and Grok">
    ...
    Claude: **Customize → Connectors → + → Add custom connector**. ChatGPT: **Settings → Apps → Advanced settings → Developer mode**, then **Settings → Apps → Create**. Grok: [grok.com/connectors](https://grok.com/connectors) → Custom.
