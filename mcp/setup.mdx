...
<Tabs>
  ...
  <Tab title="Claude">
    No file to edit. One custom connector covers claude.ai, Desktop and mobile:
  ...
  <Tab title="ChatGPT">
    **Settings → Apps → Advanced settings → Developer mode**, then **Settings → Apps → Create**:
...
<CardGroup cols={2}>
  ...
  <Card title="Claude" icon="/images/brand/icon-claude.svg" href="/mcp/clients/claude">
    One custom connector covers claude.ai, Desktop and mobile
  </Card>
