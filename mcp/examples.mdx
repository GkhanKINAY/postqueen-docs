...
These examples show the tool calls an AI agent makes behind the scenes. You don't need to write these yourself: describe what you want in natural language and your AI agent handles the rest.
