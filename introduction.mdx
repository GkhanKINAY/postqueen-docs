...
Ask her from whatever you already have open: OpenClaw, Hermes, Claude, ChatGPT, Codex, Cursor,
Grok or Grok Bot. Muse Code works today; the Muse app is coming soon.

She creates and schedules the post they already decided. The calendar is where you see every
post and manage the process.
...
<CardGroup cols={3}>
  <Card title="Agents" icon="robot" href="/agents/overview">
    Ask Claude, ChatGPT or Grok Bot for a post instead of writing one
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Grok" icon="/images/brand/icon-grok.svg" href="/agents/grok">
    Custom connector at grok.com/connectors. Web, iOS and Android
  </Card>
  <Card title="Grok Bot" icon="/images/brand/icon-grok.svg" href="/agents/grok-bot">
    Tell the Bot in chat to add the MCP URL. Not grok.com connectors
  </Card>
</CardGroup>

OpenClaw and Hermes are open source, and both drive the same CLI, so the only outside cost is the
model provider you point them at. Grok and Grok Bot reach her over MCP instead: one URL, nothing
to install.

<Card title="Muse" icon="/images/brand/icon-muse.svg" href="/agents/muse">
  Muse Code talks to her over MCP today. The Muse app is coming soon, so do not paste the MCP URL
  into Muse Connectors expecting it to work like Claude or Grok.
</Card>
