...
<Steps>
  ...
  <Step title="Fill in OAuth Details">
    ...
    **Your YouTube OAuth2 Redirect URI:**
    ...
    <Frame>
      <img src="/images/providers/youtube/youtube-001.png" alt="YouTube" />
    </Frame>
...
```
  ...
  <Step title="Add Test User">
    ...
    <Frame>
      <img src="/images/providers/youtube/YouTube-Add-Test-Users.png" alt="YouTube" />
    </Frame>
  </Step>
  ...
  <Step title="Activate YouTube's API">
    ...
    <Frame>
      <img src="/images/providers/youtube/YouTube-Enabled-APIs.png" alt="Enabled APIs" />
    </Frame>

    <Frame>
      <img src="/images/providers/youtube/Enable-APIs-and-Services.png" alt="Enabled APIs" />
    </Frame>
  </Step>
