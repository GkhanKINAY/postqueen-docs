...
<Info>
On PostQueen Cloud the Forceplay **PostQueen** app at [console.x.com](https://console.x.com) is already wired in. Open **Add Channel → X** on a **paid** workspace (trial workspaces cannot connect X). You still need **pay-per-use X API credits** on that developer account; Free/Basic/Pro tiers are not available for new developers in 2026.
