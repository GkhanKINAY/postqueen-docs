...
<Steps>
  <Step title="Create a Telegram Bot">
    ...
    ![Name Bot](/images/providers/telegram/telegram-name-bot.png)
       
       - Choose a unique username ending with "bot" (e.g., `MyPostQueenBot_bot`).

    ![Unique Bot Name](/images/providers/telegram/telegram-unique-username.png)

    Once your bot is created, **BotFather** will give you an **API Token**. Keep it safe. You will need it later.

    ![Bot Token](/images/providers/telegram/telegram-bot-token.png)
  </Step>
  ...
  <Step title="Configure Bot Group Permissions (optional but recommended)">
    ...
    ![Bot Settings](/images/providers/telegram/telegram-bot-settings.png)

    5. Click on "Group Privacy"

    ![Group Privacy](/images/providers/telegram/telegram-group-privacy.png)
