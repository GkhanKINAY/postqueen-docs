...
- Story link stickers / swipe-up links — the Instagram Graph API doesn't expose interactive sticker payloads, so PostQueen can only upload the story media.
...
<Steps>
  ...
  <Step title="Set up Redirect URI">
    ...
    **Your Instagram OAuth2 Redirect URI:**
    - Production: `https://your-postqueen-domain.com/integrations/social/instagram`
...
<Steps>
  ...
  <Step title="Set up Redirect URI">
    ...
    **Your Instagram Standalone OAuth2 Redirect URI:**
    - Production: `https://your-postqueen-domain.com/integrations/social/instagram-standalone`
