...
<Steps>
  ...
  <Step title="Select business">
    ...
    ![Select business](/images/providers/facebook/facebook-select-business.png)
  </Step>

  <Step title="Add details and create app">
    Add all your details and click Create App

    ![Create an app details page](/images/providers/facebook/facebook-create-app-details.png)
  </Step>
</Steps>
...
<Steps>
  <Step title="Set up Login for Business">
    ![Set up login for business](/images/providers/facebook/facebook-setup-login.png)
  ...
  <Step title="Set up Redirect URI">
    ...
    ![Valid OAuth Redirect URIs field in Client OAuth settings](/images/providers/instagram/instagram-redirect-uri.png)
  ...
  <Step title="Set up permissions">
    ![Advanced permissions screen](/images/providers/facebook/facebook-advanced-permissions.png)
  ...
  <Step title="Copy your credentials">
    ![App ID and App Secret on the basic settings screen](/images/providers/facebook/facebook-app-keys.png)
...
<Steps>
  ...
  <Step title="Set up Redirect URI">
    ...
    **Your Instagram Standalone OAuth2 Redirect URI:**
    ...
    - Docker: `https://redirectmeto.com/http://localhost:5000/integrations/social/instagram-standalone`
