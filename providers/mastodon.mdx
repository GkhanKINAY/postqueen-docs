...
<Steps>
  <Step title="Register your client">
    ...
    **Your Mastodon OAuth2 Redirect URI:**
    - Production: `https://your-postqueen-domain.com/integrations/social/mastodon`
...
The PostQueen backend needs network access to reach your Mastodon instance. If the connect call fails at this stage, the backend container couldn't resolve or reach the `MASTODON_URL` host.
