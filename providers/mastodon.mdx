...
| Area | Detail |
|---|---|
| Post settings | Nothing beyond `__type`. The instance a post lands on comes from the connected channel, not from the settings block: [Mastodon settings](/public-api/providers/mastodon). |
