...
<Steps>
  ...
  <Step title="Create OAuth Credentials">
    ...
    **Your Google My Business OAuth2 Redirect URI:**
    - Production: `https://your-postqueen-domain.com/integrations/social/gmb`
...
The `/integrations/social/gmb` page can surface session-replay overlay errors that mask the actual OAuth flow. The handshake usually still completes. Refresh the Channels page after authorising on Google's side. Tracked in [Known Issues](/troubleshooting/known-issues).
