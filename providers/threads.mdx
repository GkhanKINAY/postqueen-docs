...
Five hundred characters, no settings panel, nothing to configure. Threads is the shortest hop between a written thought and a published one, and she can keep replying to her own post to build the thread out.
...
<Steps>
  ...
  <Step title="Set threads API settings">
    ...
    **Your Threads OAuth2 Redirect URI:**
    ...
    - Docker: `https://redirectmeto.com/http://localhost:5000/integrations/social/threads`
