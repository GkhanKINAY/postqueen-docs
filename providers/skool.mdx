...
1. The **PostQueen Chrome Extension** installed — see the [Chrome Extension guide](/configuration/chrome-extension) for setup instructions.
...
- **"Extension not found"** — Make sure the PostQueen Chrome Extension is installed and that `EXTENSION_ID` is correctly set. See the [Chrome Extension guide](/configuration/chrome-extension).
