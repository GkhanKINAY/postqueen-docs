...
On PostQueen Cloud the extension id is already configured. Self-hosting? The extension id belongs in the instance configuration: [Chrome Extension](/configuration/chrome-extension).
