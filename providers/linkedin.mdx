...
Nine networks report analytics back to PostQueen, and a LinkedIn profile is not one of them. The [LinkedIn Page](/providers/linkedin-page) connector does report, so attach the company page if figures are what you are after. Large images are scaled down to fit inside 6000 by 6000 pixels before upload, since LinkedIn rejects anything past its pixel cap.
