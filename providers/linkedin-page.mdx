...
LinkedIn is the only provider PostQueen supports PDF posting on, and only through document-carousel posts. When you create a carousel of images on a LinkedIn Page, PostQueen combines the images into a PDF document and uploads it as a LinkedIn document share. You don't upload a PDF directly — PostQueen produces the PDF from your images.
