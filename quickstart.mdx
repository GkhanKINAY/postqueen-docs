...
<AccordionGroup>
  ...
  <Accordion title="Reveal shows nothing under API Keys" icon="key">
    The **API Keys** tab is visible to every member, but revealing or rotating the workspace key
    is an admin action. On the cloud, calling the public API also needs a plan that includes it.
