...
That is a floor for a single-user install. Plan for 4 GB or more once several people use it, and see [System Requirements](/installation/system-requirements).
