...
Add Channel. Per-network walkthroughs: [Providers](/providers/overview). Redirect URLs and
...
<AccordionGroup>
  ...
  <Accordion title="Connecting a social channel fails">
    ...
    [OAuth connect errors](/troubleshooting/oauth-connect) covers the specific messages.
  </Accordion>
