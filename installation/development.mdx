...
{/* OVERHAUL-TODO(B9): rewrite it to the style guide in CONTRIBUTING.md. Sources: this file (fix; WIP: better, use as base; audit: selfhost), main:installation/devcontainer.mdx (merge; WIP: better; audit: selfhost), main:developer-guide.mdx (delete; merge; WIP: partly better; audit: guide, selfhost). Row in page-status-2026-09-23.md. */}
