...
{/* OVERHAUL-TODO(B9): rewrite it to the style guide in CONTRIBUTING.md. Sources: this file (fix; WIP: better, use as base; audit: selfhost), main:installation/devcontainer.mdx (merge; WIP: better; audit: selfhost), main:developer-guide.mdx (delete; merge; WIP: Runs the Jest test suite" -> `tsx --test` over `*; audit: partly better (fixes Node and the test …). Row in page-status-2026-09-23.md. */}
...
<Note>
Prefer to let your editor do the setup? [Dev Container](/installation/development) runs this
...
<Steps>
  ...
  <Step title="Create your .env">
    ...
    covered under [Providers](/channels/overview).
  </Step>
...
<CardGroup cols={2}>
  ...
  <Card title="Developer guide" icon="code" href="/installation/development">
    How the codebase is organised and how to contribute
  </Card>
  <Card title="Architecture" icon="workflow" href="/introduction">
