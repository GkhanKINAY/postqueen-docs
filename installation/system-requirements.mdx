...
|---|---|---|
| CPU | 2 vCPU | 4 vCPU |
| RAM | 4 GB (Compose with Temporal + Elasticsearch) | 8 GB |
| Disk | 20 GB | 50 GB + persistent volume for uploads |

<Warning>
The official Docker Compose stack includes Temporal and Elasticsearch. Plan for **4 GB of RAM
or more** on one host (see [Docker Compose](/installation/docker-compose)). A 2 GB box will
OOM during startup. 8 GB is the comfortable point once a few people share the calendar.
</Warning>
