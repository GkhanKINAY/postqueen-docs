...
{/* OVERHAUL-TODO(B5): rewrite it to the style guide in CONTRIBUTING.md. Sources: this file (rewrite; WIP: better, use as base; audit: selfhost). Row in page-status-2026-09-23.md. */}
...
<CardGroup cols={2}>
  <Card title="What she can post to Telegram" icon="/images/channels/telegram.svg" href="/channels/telegram">
