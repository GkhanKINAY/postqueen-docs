...
{/* OVERHAUL-TODO(B5): rewrite it to the style guide in CONTRIBUTING.md. Sources: this file (fix; WIP: better, use as base; audit: selfhost). Row in page-status-2026-09-23.md. */}
...
<CardGroup cols={2}>
  <Card title="What she can post to Discord" icon="/images/channels/discord.svg" href="/channels/discord">
