...
{/* OVERHAUL-TODO(B5): rewrite it to the style guide in CONTRIBUTING.md. Sources: this file (fix; WIP: better; audit: selfhost). Row in page-status-2026-09-23.md. */}
...
<CardGroup cols={2}>
  <Card title="What she can post to Slack" icon="/images/channels/slack.svg" href="/channels/slack">
