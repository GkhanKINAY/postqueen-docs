...
The **TikTok Business** card in Add Channel runs on an app of its own, registered for TikTok's Business API, with its own pair of keys. Set up either app, or both.
...
<Steps>
  <Step title="Register the redirect URI, trailing slash included">
    ...
    - Production: `https://postqueen.example.com/integrations/social/tiktok-business/`
