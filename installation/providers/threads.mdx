...
<Steps>
  ...
  <Step title="Configure API access">
    ...
    Do not add these scopes to the Facebook + Instagram Business app, and do not mix Instagram Standalone (`instagram_business_*`) scopes here.
    ...
    Do not add `threads_profile_discovery`. PostQueen does not request it.
...
<CardGroup cols={2}>
  <Card title="What she can post to Threads" icon="/images/channels/threads.svg" href="/channels/threads">
