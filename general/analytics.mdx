...
[Per-post numbers](#per-post-metrics) live on the post itself, see
...
| TikTok | Followers, following, total likes, video count, views, recent likes, recent comments, recent shares |
...
Per-post statistics are not on this page. Open the post in the calendar and
choose **Statistics**, see
[Post actions and statistics](/general/posts/actions-and-stats). These
platforms report them:

{/* GENERATED:post-analytics */}
| Platform |
|---|
| X |
| LinkedIn Page |
...
Dribbble and TikTok Business appear here but not in the account-level table
above: they report per-post metrics only.
