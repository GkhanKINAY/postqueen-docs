...
| `callToActionUrl` | string | ❌ | URL for the CTA button. Genuinely optional: set `callToActionType` without it and the request still succeeds, with the button quietly left off the post |
