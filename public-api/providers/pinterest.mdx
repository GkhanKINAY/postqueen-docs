...
Creating the OAuth app and connecting a channel: [Pinterest setup guide](/installation/providers/pinterest).
...
Optional destination URL. When users click "Visit" on your pin, they will be taken to this URL.
  ...
  "posts": [
    {
      ...
      "value": [
        {
          ...
          "image": [
            {
              "id": "pin-image-id",
              "path": "https://uploads.postqueen.ai/decor.jpg"
            }
          ]
        }
      ],
      "settings": {
        ...
        "link": "https://blog.example.com/living-room-decor",
        "dominant_color": ""
      }
    }
  ]
  ...
  "posts": [
    {
      ...
      "value": [
        {
          ...
          "image": [
            {
              "id": "recipe-image-id",
              "path": "https://uploads.postqueen.ai/recipe.jpg"
            }
          ]
        }
      ],
      "settings": {
        ...
        "link": "https://recipes.example.com/summer-pasta",
