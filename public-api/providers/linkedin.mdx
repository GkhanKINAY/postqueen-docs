...
{/* OVERHAUL-TODO(B2): write it from _templates/api-settings.mdx. Sources: this file (fix; WIP: better, use as base; audit: api), main:public-api/providers/linkedin-page.mdx (fix; WIP: better, use as base; audit: api). Row in page-status-2026-09-23.md. */}

Creating the OAuth app and connecting a channel: [LinkedIn setup guide](/installation/providers/linkedin).
      ...
      "value": [
        {
          ...
          "image": [
            {
              "id": "image-1-id",
              "path": "https://uploads.postqueen.ai/image1.png"
            },
            {
              "id": "image-2-id",
              "path": "https://uploads.postqueen.ai/image2.png"
            },
            {
              "id": "image-3-id",
              "path": "https://uploads.postqueen.ai/image3.png"
            }
          ]
        }
      ],
