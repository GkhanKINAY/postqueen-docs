...
Creating the OAuth app and connecting a channel: [YouTube setup guide](/installation/providers/youtube).
...
```json
{
  "thumbnail": {
    "id": "thumbnail-id",
    "path": "https://uploads.postqueen.ai/thumbnail.jpg"
  }
}
```
  ...
  "posts": [
    {
      ...
      "value": [
        {
          "content": "In this video, I'll show you how to use the PostQueen API to automate your social media workflow.\n\nTimestamps:\n0:00 Introduction\n1:30 Setup\n5:00 First API call\n10:00 Conclusion",
          "image": [
            {
              "id": "video-id",
              "path": "https://uploads.postqueen.ai/tutorial.mp4"
            }
          ]
        }
      ],
      "settings": {
        "__type": "youtube",
        "title": "How to Use PostQueen API - Complete Tutorial",
        "type": "public",
        "selfDeclaredMadeForKids": "no",
        "tags": [
          { "value": "postqueen", "label": "postqueen" },
          { "value": "api", "label": "api" },
          { "value": "tutorial", "label": "tutorial" },
      ...
      "value": [
        {
          ...
          "image": [
            {
              "id": "video-id",
              "path": "https://uploads.postqueen.ai/video.mp4"
            }
          ]
        }
      ],
