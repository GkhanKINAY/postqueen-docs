...
The forum experience ID where the post will be published. Each company can have multiple forums — select the target forum in the PostQueen UI to obtain its ID.
