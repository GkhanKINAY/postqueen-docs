...
{/* OVERHAUL-TODO(B2): write it from _templates/api-settings.mdx. Sources: this file (fix; WIP: better, use as base; audit: api), main:public-api/providers/instagram-standalone.mdx (fix; WIP: better, use as base; audit: api). Row in page-status-2026-09-23.md. */}
...
<CardGroup cols={2}>
  <Card title="Connect the channel" icon="plug" href="/channels/instagram">
    Create the OAuth app and link the Instagram account.
  </Card>
  <Card title="Standalone accounts" icon="/images/channels/instagram.svg" href="/public-api/providers/instagram">
    The settings for channels connected without Facebook Business.
  </Card>
  <Card title="Search for audio" icon="zap" href="/public-api/integrations/trigger">
