...
Every post to Farcaster carries a `settings` object with `"__type": "wrapcast"`, the API's name for Farcaster. Read the live schema for your channel with [integration settings](/public-api/integrations/settings).
