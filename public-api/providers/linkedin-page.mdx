...
sidebarTitle: LinkedIn Page
description: 'API settings for posting to LinkedIn company pages'
---

Creating the OAuth app and connecting a channel: [LinkedIn Page setup guide](/installation/providers/linkedin-page).
...
Full field reference, including `post_as_images_carousel` and
`carousel_name`: [LinkedIn settings](/public-api/providers/linkedin).
