...
Creating the OAuth app and connecting a channel: [Skool setup guide](/providers/skool).
...
<Note>
Skool uses the PostQueen Chrome Extension for authentication. Make sure the extension is installed and configured before using the API. Setup: [Skool provider guide](/providers/skool).
</Note>
