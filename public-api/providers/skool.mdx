...
<Note>
Skool uses the PostQueen Chrome Extension for authentication. Make sure the extension is installed and configured before using the API. See the [Skool provider guide](/providers/skool) for setup instructions.
</Note>
