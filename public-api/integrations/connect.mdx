...
description: 'Return the OAuth URL that starts a human channel-connect flow.'
openapi: 'GET /social/{integration}'
---

{/* OVERHAUL-TODO(B8): rewrite it to the style guide in CONTRIBUTING.md. Sources: this file (rewrite; WIP: better, use as base; audit: api). Row in page-status-2026-09-23.md. */}
