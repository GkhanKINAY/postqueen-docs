...
```json
[
  { "id": "cmg1ozx2c0000qz0h8c7w5v3n", "name": "PostQueen", "identifier": "bluesky", "disabled": false, "profile": "postqueen.bsky.social", "picture": "https://cdn.example.com/avatar.png" }
]
```
...
| `DRAFT` | Saved without a time to go out |
