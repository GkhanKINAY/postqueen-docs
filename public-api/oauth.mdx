...
<Steps>
  ...
  <Step title="Redirect Users to Authorize">
    ...
    **Example:**
    ...
    ```bash
    https://platform.postqueen.ai/oauth/authorize?client_id=pca_VklHTpdEJ6dJ73FHQEJ97qVA0lcMDsrs&response_type=code&state=random123
    ```
...
const POSTQUEEN_URL = 'https://platform.postqueen.ai';
