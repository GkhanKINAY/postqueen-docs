...
Fetch a remote URL and store the result as a PostQueen media asset. Useful when your media already lives on a CDN or external storage and you don't want to round-trip it through your client.
...
- Don't link to signed URLs that may expire before PostQueen fetches them.
