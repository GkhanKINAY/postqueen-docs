...
| **Clipping minutes** | 60 | 120 | 300 | 600 |
...
**Clipping minutes** are spent by [video clipping](/general/clipping), one for
every minute of the source video, however many clips come out of it. They reset
on the same monthly anniversary. A clipping that fails without producing a clip
gives its minutes back.
