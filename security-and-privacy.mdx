...
|---|---|
| Facebook, Instagram, Threads, TikTok, X, YouTube, LinkedIn, Pinterest, Reddit, Google Business Profile, Discord, Slack, Mastodon, Tumblr, Twitch, Kick, VK, Dribbble, MeWe, Whop | On the network's own sign-in screen. PostQueen keeps a token with the permissions you approved there, and never sees your password. |
...
| Telegram | By adding PostQueen's bot to your channel or group as an administrator. PostQueen never sees your password. |
| Farcaster | By approving PostQueen in the Farcaster app on your phone. |
| Skool | Skool has no public API, so PostQueen connects through the PostQueen browser extension with your own Skool session. [Its page](/channels/skool) explains what that means for your account. |
