...
Running her yourself? Everything above still works. Swap the base URL for `https://YOUR-DOMAIN/api/public/v1` and keep the header, the body and the modules as they are.
