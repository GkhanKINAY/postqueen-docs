...
Grab your API key from [app.postqueen.ai](https://app.postqueen.ai): open **Settings → API Keys** and hit **Reveal**. Treat it like a password and paste it only into the Zap step that needs it.
