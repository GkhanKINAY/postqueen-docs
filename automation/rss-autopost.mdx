...
<Frame>
  <img src="/images/brand/flow-drafts.svg" alt="An RSS feed checked hourly, its newest item becoming a captioned draft in the next open calendar slot" />
</Frame>
...
<Card title="RSS to PostQueen in n8n" icon="/images/brand/icon-n8n.svg" href="/automation/n8n">
