...
```bash
postqueen integrations:trigger reddit-id restrictions -d '{"subreddit":"programming"}'
```
...
postqueen integrations:trigger "$INTEGRATION_ID" restrictions -d '{"subreddit":"programming"}'
