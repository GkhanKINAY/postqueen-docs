...
One command puts a post on her calendar. From there she runs on your terms: a scheduled post goes out on time without another word from you, and `-t draft` holds it until you approve it.
