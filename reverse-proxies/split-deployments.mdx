...
{/* OVERHAUL-TODO(B9): rewrite it to the style guide in CONTRIBUTING.md. Sources: this file, moved from reverse-proxies/websockets-and-dev (rewrite; WIP: stale; audit: selfhost). Row in page-status-2026-09-23.md. */}
...
<CardGroup cols={2}>
  ...
  <Card title="Channel connect errors" icon="plug-circle-xmark" href="/troubleshooting/common-errors">
