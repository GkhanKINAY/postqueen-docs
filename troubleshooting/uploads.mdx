---
title: Uploads & Media
description: 'Payload limits, video failures and cancel-in-flight behaviour'
---

## Body size limit

The PostQueen backend accepts JSON bodies up to **50 MB** on the post-creation
...
fall back to the framework default and are much smaller. Do not inline
