...
A charge is refunded in full if you ask within 30 days of it, on a monthly or a yearly plan ([Refunds](/cloud/subscription#refunds)). For refund requests, billing questions, or anything that needs a human:
...
Cloud billing map (trial, portal, cancel, caps): [Cloud](/cloud/overview). There is no self-serve refund button on Billing.
