...
- Allow third-party scripts on `platform.postqueen.ai`.
...
- **Discord:** [discord.postqueen.ai](https://discord.postqueen.ai) — `#support` channel.
- **GitHub:** [open an issue](https://github.com/GkhanKINAY/postqueen-app/issues) for product bugs.
- **Email:** see the contact section on [postqueen.ai](https://postqueen.ai).
