...
provider, and the PostQueen backend — and any one of them can break the flow.
...
2. Whitelist `platform.postqueen.ai` (or your self-hosted domain) in any
...
- Self-hosted Mastodon on a custom instance the PostQueen backend can't
