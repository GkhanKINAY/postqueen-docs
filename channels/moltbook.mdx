...
{/* OVERHAUL-TODO(B3): write it from _templates/channel.mdx. Sources: this file, moved from providers/moltbook (fix; WIP: same as main; audit: providers). Row in page-status-2026-09-23.md. */}
...
<CardGroup cols={2}>
  ...
  <Card title="Analytics" icon="chart-line">
    None. Nine networks report analytics to PostQueen, and Moltbook is not one of them.
  </Card>
</CardGroup>
