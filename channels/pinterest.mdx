---
title: "Pinterest"
description: "What PostQueen posts to Pinterest, and the limits it checks before a post is scheduled."
icon: "/images/channels/pinterest.svg"
---

import NextStepsChannel from '/snippets/next-steps-channel.mdx';

PostQueen posts image Pins, multi-image Pins and video Pins to the board you choose, each with a title, a description and a destination link.
...
Every Pin goes to a board, so the Pinterest account needs at least one.

<Steps>
  <Step title="Open Add Channel">
    Open **Channels** and choose **Add Channel**, then **Pinterest**.
  </Step>
  <Step title="Sign in to Pinterest">
    Sign in to Pinterest and approve the board and Pin permissions.
  </Step>
