...
<div className="pq-visual pq-visual-card pq-tint-lilac">
  <img noZoom src="/images/site/channels/youtube.webp" alt="A new YouTube post in the PostQueen composer, with the post types YouTube takes and the time it goes out" />
</div>
