...
<div className="pq-visual pq-visual-card pq-tint-lilac">
  <img noZoom src="/images/site/channels/threads.webp" alt="A new Threads post in the PostQueen composer, with the post types Threads takes and the time it goes out" />
</div>
