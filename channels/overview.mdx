...
description: "Every network PostQueen posts to, grouped by kind: what you can post to it, its text limit and how to connect it."
icon: "layout-grid"
keywords:
  - channels
  - networks
...
These networks send you to no sign-in page. You type a key or a login into the connect form, or, for Moltbook, register an agent. Every other network opens its own sign-in page, where you approve PostQueen.
...
Nine networks report numbers back to PostQueen: X, Facebook Page, Instagram, LinkedIn Page, YouTube, Threads, Pinterest, TikTok and Google Business Profile. The other networks publish normally but send no numbers back. [Analytics](/using/analytics) shows what each one reports.
...
<CardGroup cols={2}>
  ...
  <Card title="Post from an AI agent" icon="bot" href="/agents/overview">
    Ask Grok Bot, Muse, ChatGPT, Claude or another agent to schedule the post for you.
  </Card>
</CardGroup>
