...
| Status | Networks | What it means |
|---|---|---|
| <ChannelBadge status="available" /> | 8 | Connect it from **Add Channel** today. |
| <ChannelBadge status="in-review" /> | 6 | It connects, with a limit, until the network approves PostQueen's app. The limit is below and on the network's page. |
| <ChannelBadge status="soon" /> | 17 | Listed in **Add Channel**, but it cannot be connected on PostQueen yet. Its page says what it will post. |
...
<CardGroup cols={3}>
  ...
  <Card title="TikTok" icon="/images/channels/tiktok.svg" href="/channels/tiktok">
    ...
    Videos and photo posts of up to 35 images, or a draft in your TikTok inbox. 2,000 characters.
  </Card>
  <Card title="Facebook" icon="/images/channels/facebook.svg" href="/channels/facebook">
    <ChannelBadge status="in-review" />

    Page posts with text, links, photos or video, and Page Stories. 63,206 characters.
  </Card>
  <Card title="X" icon="/images/channels/x.svg" href="/channels/x-twitter">
    <ChannelBadge status="in-review" />

    Posts, threads, images, GIFs and video, Community posts and Articles. 280 characters, 4,000 on verified accounts.
  </Card>
  <Card title="LinkedIn" icon="/images/channels/linkedin.svg" href="/channels/linkedin">
    <ChannelBadge status="soon" />

    Posts to your profile and company pages, with images, video and document carousels. 3,000 characters.
  </Card>
...
Each of these networks connects today, within this limit, until it approves PostQueen's app:
...
Nine networks report numbers back to PostQueen: X, Facebook Page, Instagram, LinkedIn Page, YouTube, Threads, Pinterest, TikTok and Google Business Profile. The available networks above publish normally but send no numbers back. [Analytics](/using/analytics) shows what each one reports.
