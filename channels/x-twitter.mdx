...
PostQueen refuses a post that breaks these rules and shows the message in the composer. The post and every thread reply are checked on their own.
...
<Note>
X is in review, and connecting it is locked during the free trial. On the X step in **Add Channel**, choose **End free trial to unlock X** to start your plan now, or wait for the trial to end. X channels you connected before keep working.
</Note>
