...
<div className="pq-visual pq-visual-card pq-tint-lilac">
  <img noZoom src="/images/site/channels/x.webp" alt="A new X post in the PostQueen composer, with the post types X takes and the time it goes out" />
</div>
...
The **Long posts** setting, which raises the limit to 4,000 characters, is read from X when you connect. Change it later on the channel's page under **X options**, or in the channel's menu on **Analytics** under **Additional Settings**.
