...
{/* OVERHAUL-TODO(B4): write it from _templates/channel.mdx. Sources: this file, moved from providers/vk (fix; WIP: better, use as base; audit: providers). Row in page-status-2026-09-23.md. */}
