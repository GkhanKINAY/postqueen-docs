...
<div className="pq-visual pq-visual-card pq-tint-lilac">
  <img noZoom src="/images/site/channels/devto.webp" alt="A new DEV (dev.to) post in the PostQueen composer, with the post types DEV (dev.to) takes and the time it goes out" />
</div>
