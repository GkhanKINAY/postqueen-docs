...
Each DEV post has its own settings in the composer:
...
DEV has no follow-ups: the composer shows no **Add comment** button for a DEV channel.
...
<AccordionGroup>
  <Accordion title="DEV does not accept the key">
    The connect fails, or shows “Invalid credentials”. Copy the key again from **Settings**, **Extensions**, or generate a new one, and connect again.
  </Accordion>
