...
PostQueen will send messages, photos, videos and albums to your Telegram channels and groups, public or private, through PostQueen's bot at the time you pick.
...
<CardGroup cols={2}>
  ...
  <Card title="Post types" icon="layers">
    Text message, message with a photo, video or file, album, and follow-up replies.
  </Card>
...
<Note>
Telegram is listed in **Add Channel**, but it cannot be connected on PostQueen yet. It will connect through PostQueen's bot, which you add to your channel or group as an administrator.
</Note>

## Post settings

A Telegram post has no settings of its own. It goes to the chat the channel is connected to. The API side is on [Telegram posting settings](/public-api/providers/telegram).
