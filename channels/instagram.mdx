...
{/* OVERHAUL-TODO(B2): write it from _templates/channel.mdx. Sources: this file, moved from providers/instagram (fix; WIP: better, use as base; audit: providers). Row in page-status-2026-09-23.md. */}
