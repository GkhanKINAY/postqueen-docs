---
title: "Farcaster"
description: "What PostQueen will post to Farcaster, your home feed and Farcaster channels, and the limits it checks before a cast is scheduled."
...
<CardGroup cols={2}>
  <Card title="Text" icon="type">
    Up to 1,024 bytes. A plain Latin letter is one byte, while accented letters, emoji and other scripts take 2 to 4, so they fit fewer characters.
  </Card>
...
<Note>
Farcaster is listed in **Add Channel**, but it cannot be connected on PostQueen yet. It will connect when you approve PostQueen in the Farcaster app on your phone.
</Note>

## Post settings

Each Farcaster post in the composer can name channels:
