...
<div className="pq-visual pq-visual-card pq-tint-lilac">
  <img noZoom src="/images/site/channels/lemmy.webp" alt="A new Lemmy post in the PostQueen composer, with the post types Lemmy takes and the time it goes out" />
</div>
