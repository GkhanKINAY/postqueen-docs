...
{/* OVERHAUL-TODO(B5): write it from _templates/channel.mdx. Sources: this file, moved from providers/skool (rewrite; WIP: partly better; audit: providers). Row in page-status-2026-09-23.md. */}
...
<CardGroup cols={2}>
  ...
  <Card title="Analytics" icon="chart-line">
    None. Nine networks report analytics to PostQueen, and Skool is not one of them.
  </Card>
</CardGroup>
...
2. An active **Skool account**: you must be logged in to [skool.com](https://www.skool.com) in the same browser where the extension is installed.

Self-hosting? The extension id belongs in the instance configuration: [Chrome Extension](/configuration/chrome-extension).
