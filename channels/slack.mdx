...
<CardGroup cols={2}>
  ...
  <Card title="Media" icon="image">
    Images, shown under the text. Slack shows PNG, JPG and GIF. No video.
  </Card>
...
<Note>
Slack is listed in **Add Channel**, but it cannot be connected on PostQueen yet. Connecting will install PostQueen's Slack app in your workspace, so you will need permission to install apps there.
</Note>
