---
title: "Tumblr"
description: "What PostQueen posts to Tumblr, and the limits it checks before a post is scheduled."
icon: "/images/channels/tumblr.png"
---

import NextStepsChannel from '/snippets/next-steps-channel.mdx';

PostQueen posts Tumblr text posts with a title, a link, a source URL and tags, plus up to 30 images and a video, to the blog you choose.

<div className="pq-visual pq-visual-card pq-tint-lilac">
  <img noZoom src="/images/site/channels/tumblr.webp" alt="A new Tumblr post in the PostQueen composer, with the post types Tumblr takes and the time it goes out" />
</div>
...
Each channel is one of your blogs.

<Steps>
  <Step title="Open Add Channel">
    Open **Channels** and choose **Add Channel**, then **Tumblr**.
  </Step>
  <Step title="Sign in to Tumblr">
    Sign in to Tumblr and approve access.
  </Step>
  <Step title="Pick the blog">
    Choose which of your blogs to post to.
  </Step>
