...
- Google's reference asks for start and end times as well as dates. Events without times, and every offer, go out without them, so Google may refuse them. Offers have not been tested end to end yet.
