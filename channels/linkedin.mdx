---
title: "LinkedIn"
description: "What PostQueen posts to LinkedIn profiles and company pages, and the limits it checks before a post is scheduled."
icon: "/images/channels/linkedin.svg"
---

import NextStepsChannel from '/snippets/next-steps-channel.mdx';

PostQueen posts to your LinkedIn profile and to the company pages you manage: text, images, multi-image posts of up to 20 images, MP4 video, and swipeable document carousels built from your images.

<div className="pq-visual pq-visual-card pq-tint-lilac">
  <img noZoom src="/images/site/channels/linkedin.webp" alt="A new LinkedIn post in the PostQueen composer, with the post types LinkedIn takes and the time it goes out" />
</div>
...
LinkedIn has two tiles in **Add Channel**: **LinkedIn** for your personal profile, and **LinkedIn Page** for a company page where you are an administrator or content administrator.

<Steps>
  <Step title="Open Add Channel">
    Open **Channels** and choose **Add Channel**, then **LinkedIn** or **LinkedIn Page**.
  </Step>
  <Step title="Sign in to LinkedIn">
    Sign in to LinkedIn and approve the permissions.
  </Step>
  <Step title="Pick the page">
    For **LinkedIn Page**, choose the company page. Only pages where you are an administrator or content administrator appear.
  </Step>
