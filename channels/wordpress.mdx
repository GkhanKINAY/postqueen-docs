...
<div className="pq-visual pq-visual-card pq-tint-lilac">
  <img noZoom src="/images/site/channels/wordpress.webp" alt="A new WordPress post in the PostQueen composer, with the post types WordPress takes and the time it goes out" />
</div>
