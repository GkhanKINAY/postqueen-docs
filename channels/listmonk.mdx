...
<CardGroup cols={2}>
  ...
  <Card title="Analytics" icon="chart-line">
    No analytics for Listmonk in PostQueen.
  </Card>
</CardGroup>
...
Each Listmonk post has its own settings in the composer:
...
Listmonk has no follow-ups: the composer shows no **Add comment** button for a Listmonk channel.
