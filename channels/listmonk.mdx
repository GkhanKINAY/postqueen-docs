...
{/* OVERHAUL-TODO(B3): write it from _templates/channel.mdx. Sources: this file, moved from providers/listmonk (fix; WIP: same as main; audit: providers). Row in page-status-2026-09-23.md. */}

<img src="/images/channels/listmonk.svg" alt="Listmonk" height="44" noZoom style={{ height: "44px", marginBottom: "1.25rem" }} />

<NeverShare />

Listmonk is the one channel in the calendar that sends email. It connects the way self-hosted software usually does, with an address and a login rather than an OAuth app, so there is nothing to register with a developer portal. You click **Listmonk** in **Add Channel** and type three values into the form that opens.
...
<CardGroup cols={2}>
  ...
  <Card title="Analytics" icon="chart-line">
    None. Nine networks report analytics to PostQueen, and Listmonk is not one of them. Open rates stay in Listmonk where they are collected.
  </Card>
</CardGroup>
