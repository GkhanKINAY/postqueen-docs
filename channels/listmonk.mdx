...
<div className="pq-visual pq-visual-card pq-tint-lilac">
  <img noZoom src="/images/site/channels/listmonk.webp" alt="A new Listmonk post in the PostQueen composer, with the post types Listmonk takes and the time it goes out" />
</div>
