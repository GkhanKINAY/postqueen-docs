...
<div className="pq-visual pq-visual-card pq-tint-lilac">
  <img noZoom src="/images/site/channels/tiktok.webp" alt="A new TikTok post in the PostQueen composer, with the post types TikTok takes and the time it goes out" />
</div>
...
Any TikTok account can connect. You don't need a business account. **Add Channel** also lists **TikTok Business** for business accounts, with music and location search on top of the same settings.
...
- TikTok does not allow branded content to be private, so a post marked **Branded content** needs an audience other than **Self only**.
