...
The caption is also held to 2,000 characters.
...
- **Who can see this video?**: the audiences your account allows, from **Public to everyone**, **Mutual follow friends**, **Follower of creator** and **Self only**. Nothing is preselected. Choose **Self only** while TikTok is in review.
...
TikTok takes no follow-up comments or threads in PostQueen. The composer offers no follow-up parts for a TikTok post.

## Good to know

- While TikTok is in review, only **Self only** publishes. Because TikTok does not allow branded content to be private, a post marked **Branded content** cannot be published until the review is done.
...
<AccordionGroup>
  <Accordion title="This TikTok app has not passed TikTok's review yet">
    The full message ends: can only publish with the "Self only" privacy level. Set **Who can see this video?** to **Self only** and schedule the post again. Other audiences open up when TikTok's audit of PostQueen's app passes.
  </Accordion>
