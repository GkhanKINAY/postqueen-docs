...
<div className="pq-visual pq-visual-card pq-tint-lilac">
  <img noZoom src="/images/site/channels/nostr.webp" alt="A new Nostr post in the PostQueen composer, with the post types Nostr takes and the time it goes out" />
</div>
