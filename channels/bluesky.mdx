...
<div className="pq-visual pq-visual-card pq-tint-lilac">
  <img noZoom src="/images/site/channels/bluesky.webp" alt="A new Bluesky post in the PostQueen composer, with the post types Bluesky takes and the time it goes out" />
</div>
