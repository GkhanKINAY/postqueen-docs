---
title: "Discord"
description: "What PostQueen will post to Discord text and announcement channels, and the limits it checks before a post is scheduled."
...
PostQueen will post messages with attachments and mentions to the text and announcement channels of your Discord servers, sent by PostQueen's bot.
...
**Not supported:** forum channels, embeds, polls, and more than one channel of the same server in one post.

## Connect Discord

<Note>
Discord is listed in **Add Channel**, but it cannot be connected on PostQueen yet. Connecting will add PostQueen's bot to one server, which needs the **Manage Server** permission there.
</Note>
...
- The bot asks for View Channels, Send Messages, Embed Links, Attach Files and the thread permissions. If a channel limits who can see it, let the bot's role view it and attach files there.
