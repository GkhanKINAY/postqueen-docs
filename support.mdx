...
<Info>
**Self-hosting?** Support runs on volunteers who answer in their own evenings, for free, so there
is no support desk and no promised reply time. Write the detail down while it is fresh, then give
them a day or two. GitHub is public and searchable, so your report usually helps the next person
