...
| **Temporal** | Holds the clock, retries failures, refreshes platform tokens. Required. There is no optional Redis-queue mode | no |
| **Redis** | Caching and rate limiting | no |
