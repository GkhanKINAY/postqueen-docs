...
<Note>
The packaged PostQueen extension is coming soon to the Chrome Web Store. Until then, you build it from source. The same steps work for both cloud and self-hosted setups.
</Note>
