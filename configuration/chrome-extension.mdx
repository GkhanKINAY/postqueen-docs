...
<Note>
A pre-packaged PostQueen extension is not yet published to the Chrome Web Store. For now, build it from source as shown below — this is the supported path for both self-hosted and cloud setups.
</Note>
...
<Steps>
  <Step title="Build the Extension">
    Build the extension from the [PostQueen monorepo](https://github.com/GkhanKINAY/postqueen-app):
