...
| `SUPPORT_EMAIL` | Where **Contact support** and **Report a bug** in the Help menu address their mail. Defaults to `support@postqueen.ai`, so set it to an inbox you read. |
