...
<Steps>
  <Step title="Create an Application/Provider on the Authentik side">
    ...
    - `redirect_uri` => `https://postqueen.yourserver.com/settings`
  ...
  <Step title="Configure logo URL">
    ```env
    NEXT_PUBLIC_POSTQUEEN_OAUTH_LOGO_URL="https://raw.githubusercontent.com/walkxcode/dashboard-icons/master/png/authentik.png"
    ```
