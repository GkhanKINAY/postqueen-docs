...
Open the arrow next to **Create Post** in the header and choose **AI post**. Write at least 10 characters under **Write anything** (links are fine), pick an **Output format** and a **Tone**, tick **Add pictures?** for images, and choose **Generate**. The composer opens with the result to check and schedule.
...
- Chatting and rewriting do not use credits. Only images do.
...
| "You are out of AI credits for this month." | Wait for your image credits to reset, or move to a larger plan in **Billing**. |
...
<CardGroup cols={2}>
  ...
  <Card title="AI images and media integrations" icon="sparkles" href="/using/ai-images-and-video">
    Styles, shapes and monthly image credits.
  </Card>
