...
{/* OVERHAUL-TODO(B1): write it from _templates/guide-task.mdx. Sources: this file, moved from using/assistant (rewrite; WIP: better, use as base; audit: guide). Row in page-status-2026-09-23.md. */}
...
<CardGroup cols={3}>
  <Card title="Talk to her outside the app" icon="messages-square" href="/agents/overview">
    The same assistant, reached from your chat apps, your editor or your terminal
  </Card>
  <Card title="Connect your own AI tools" icon="plug" href="/agents/overview">
...
<CardGroup cols={2}>
  <Card title="Talk to her outside the app" icon="bot" href="/agents/overview">
  ...
  <Card title="Media and design" icon="image" href="/using/media-library">
