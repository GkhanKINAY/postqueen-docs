...
{/* OVERHAUL-TODO(B1): write it from _templates/guide-task.mdx. Sources: this file (rewrite; WIP: same as main; audit: guide). Row in page-status-2026-09-23.md. */}
...
<CardGroup cols={3}>
  <Card title="Channels from the CLI" icon="terminal" href="/cli/managing-posts">
...
<CardGroup cols={2}>
  <Card title="Teams" icon="user-group" href="/using/team">
