...
Both are monthly credits, counted from the same subscription anniversary as posts. Generating one image spends one image credit, generating one video spends one video credit, and the counters run independently. Run out of image credits and the two entry points behave differently. **AI Image** in the composer simply produces nothing. Only the **AI Img** tab inside the picture editor tells you and opens billing.
