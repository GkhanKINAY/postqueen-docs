...
<Info>
The **AI Img** tab inside the picture editor is a separate switch: it shows up on Growth and above, so a Creator organization has image credits but not that tab. **Generate** is the button you press once you are inside it.
</Info>
...
| **AI Img** tab in the picture editor | The plan includes the image generator, which is Growth and above |
...
- Your own account reports itself as **AGENCY** with 10,000 channels, the tier the interface labels Ultimate, which is what makes every tier-gated tab in Settings show up.
