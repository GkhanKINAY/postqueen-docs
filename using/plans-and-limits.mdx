...
Available on every paid plan, from Creator upward. Two things have to be true for a call to work: the organization needs a subscription on record, and you need the key. The key is under **Connections > API Keys**. Only a workspace admin can reveal or rotate it; members see it masked.
