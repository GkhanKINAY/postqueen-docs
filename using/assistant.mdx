...
<Info>
The in-app assistant is the same sixteen tools MCP exposes, minus `ask_postqueen`. Over MCP your client can drive those tools itself or hand the whole job to her. In the app you already *are* talking to her, so that seventeenth tool is not listed. [Agents overview](/agents/overview) and [MCP introduction](/mcp/introduction).
</Info>
...
<CardGroup cols={3}>
  ...
  <Card title="Connect your own AI tools" icon="plug" href="/mcp/setup">
    Point an MCP client at her from Settings → API Keys and it gets the same tools
  </Card>
