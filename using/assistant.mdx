...
<Info>
The in-app assistant is the same thirteen tools MCP exposes, minus `ask_postqueen`. Over MCP your client can drive those tools itself or hand the whole job to her. In the app you already *are* talking to her, so that fourteenth tool is not listed. [Agents overview](/agents/overview) and [MCP introduction](/mcp/introduction).
</Info>

## What she can reach from the chat

Thirteen tools sit behind the conversation. You never call them by name, but this is the honest list of what she can touch:
