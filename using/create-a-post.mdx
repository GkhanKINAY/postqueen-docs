...
- On X, the settings card has **Add Re-posters**: pick a **Delay** and your other X channels under **Accounts that will engage:** and they repost the post. X can be connected once the free trial ends, or right away if you end the trial early.
...
<CardGroup cols={2}>
  ...
  <Card title="All channels" icon="layout-grid" href="/channels/overview">
    What each network can post, and how to connect it.
  </Card>
</CardGroup>
