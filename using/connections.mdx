...
<Frame>
  <img className="pq-shot" src="/images/app/connections.webp" alt="The Connections window with the API key hidden, its copy buttons, and cards for Claude, ChatGPT, Cursor, Grok and other agents" />
</Frame>
...
Each agent has a setup guide in these docs: start at [AI agents](/agents/overview).
