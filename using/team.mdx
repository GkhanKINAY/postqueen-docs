...
<Frame>
  <img className="pq-shot" src="/images/app/team.webp" alt="Settings open on Teams, listing a Super Admin, an Admin and a User, with Invite member" />
</Frame>
...
- **Leave** the workspace yourself from your own row, after "Are you sure you want to leave this workspace?". The last Super Admin cannot leave: [hand the workspace over](#hand-the-workspace-to-someone-else) first.

Users do not see **Teams**, so a User cannot leave on their own. To leave a workspace as a User, ask one of its Admins to remove you.
