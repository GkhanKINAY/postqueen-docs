...
{/* OVERHAUL-TODO(B1): write it from _templates/guide-task.mdx. Sources: this file, moved from automation/webhooks (fix; WIP: better, use as base; audit: cli-help). Row in page-status-2026-09-23.md. */}
...
<CardGroup cols={3}>
  ...
  <Card title="n8n" icon="/images/brand/icon-n8n.svg" href="/public-api/n8n">
