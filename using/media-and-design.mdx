...
The two type rows differ because the picker is permissive and the check happens on the way in.
Hand it something outside the second list and it is refused after you choose it, not before.
