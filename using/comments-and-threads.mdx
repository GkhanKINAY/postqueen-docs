...
X, Threads, Facebook, Instagram, TikTok and YouTube are **In review**, with limits until the platform approves PostQueen. The Soon networks and their comment support are on [Channels and their status](/channels/overview).
...
| A notification that a network "cannot post comments" after publishing | The post went out and the extra parts did not. Nothing else to do; the first part is unaffected. |
