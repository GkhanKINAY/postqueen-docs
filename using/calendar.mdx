...
Click the body of the card and the editor opens on that post. Hover the strip and the tag names give way to a row of icons. Preview, duplicate, statistics, delete and the client share link: [Post actions and stats](/using/posts/actions-and-stats).
...
<Note>
Tags paint the calendar. They do not change what it shows: the calendar filters on dates and customers, and the list adds state on top of that. Tags versus `#hashtags`: [Tags and hashtags](/using/tags-and-hashtags).
</Note>
