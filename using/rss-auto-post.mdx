...
{/* OVERHAUL-TODO(B1): write it from _templates/guide-task.mdx. Sources: this file, moved from automation/rss-autopost (rewrite; WIP: better, use as base; audit: cli-help). Row in page-status-2026-09-23.md. */}
...
<Card title="RSS to PostQueen in n8n" icon="/images/brand/icon-n8n.svg" href="/public-api/n8n">
