...
**Where:** **Social Sets** and **Signatures** under **More** in the left rail (the same pages as **Settings > Social Sets** and **Settings > Signatures**). Tags are in the composer, at the bottom.
...
<Steps>
  ...
  <Step title="Choose whether it is added on its own">
    Tick **Auto add signature?** to add it to a post you start from an empty calendar slot. Only one signature in the workspace can have this on; ticking it on one clears it on the others.
  </Step>
  <Step title="Save">
...
<Steps>
  ...
  <Step title="Pick or create tags">
    Tick existing tags, or choose **Add New Tag** and give the new one a **Name** and a **Tag Color**, then **Save**.
  </Step>
...
- The tag list has no rename. To delete a tag, open the list and choose the cross next to a tag that is not ticked; PostQueen asks first, by name. Deleting it removes it for the whole workspace.
...
<CardGroup cols={2}>
  ...
  <Card title="Settings" icon="settings" href="/using/settings">
