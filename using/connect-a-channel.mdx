...
<Info>
On PostQueen Cloud every supported network is already in **Add Channel**. Running your own instance? Some networks only appear after you register an OAuth app and restart. Each [self-hosting provider page](/installation/providers/instagram) walks through that.
</Info>
