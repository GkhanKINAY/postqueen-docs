...
The skill is for agents that run shell commands, such as OpenClaw, Hermes Agent, Claude Code, Cursor, Gemini CLI and Grok Build. Chat assistants such as Claude, ChatGPT and Grok do not run commands on your machine: connect them over [MCP](/mcp/introduction) instead.
...
- **The networks PostQueen supports,** and how to check which ones your workspace has connected.
