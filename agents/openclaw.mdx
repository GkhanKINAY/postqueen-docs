...
{/* OVERHAUL-TODO(B7): write it from _templates/agent.mdx. Sources: this file (fix; WIP: better, use as base; audit: agents). Row in page-status-2026-09-23.md. */}

<Frame>
  <img src="/images/brand/spotlight-openclaw.svg" alt="OpenClaw bridging WhatsApp, Telegram, Slack and Discord to the postqueen CLI on your own machine" />
</Frame>
...
<Steps>
  ...
  <Step title="Export your API key">
    Your key lives in the app at [app.postqueen.ai](https://app.postqueen.ai): open **Connections > API Keys** and click **Reveal**. Only a workspace admin can reveal the key. Then export it in the environment the OpenClaw Gateway runs in:
...
<Frame>
  <img src="/images/brand/phone-openclaw.svg" alt="She answers in your pocket: you ask in the OpenClaw chat for today's podcast to go to X and LinkedIn at 5pm, and she replies that two posts are scheduled and waiting on your calendar" />
</Frame>
