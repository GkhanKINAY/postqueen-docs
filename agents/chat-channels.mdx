...
| Her skill | Teaches the agent her full command set, so it works from documented flags instead of guessing. See [Install the skill](/agents/skill) |
...
<CardGroup cols={2}>
  ...
  <Card title="Install the skill" icon="graduation-cap" href="/agents/skill">
