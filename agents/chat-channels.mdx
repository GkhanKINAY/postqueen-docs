...
<CardGroup cols={2}>
  <Card title="WhatsApp" icon="/images/brand/app-whatsapp.svg" href="#whatsapp">
    Voice-note her from your phone. QR login through OpenClaw
  </Card>
  <Card title="Telegram" icon="/images/brand/app-telegram.svg" href="#telegram">
    The quickest of the four. One bot token and no plugin to add
  </Card>
  <Card title="Slack" icon="/images/brand/app-slack.svg" href="#slack">
    Ask her from any channel. Good for a team
  </Card>
  <Card title="Discord" icon="/images/brand/app-discord.svg" href="#discord">
