...
<Tip>
Prefer tool calls to shell commands? Connect over MCP and you get the same capabilities as 14 tools,
...
Your key lives in the app at [app.postqueen.ai](https://app.postqueen.ai): open **Settings → API Keys** and click **Reveal**. Treat it like a password, since it grants full access to your account.
</Warning>
...
<CardGroup cols={2}>
  ...
  <Card title="MCP setup" icon="plug" href="/mcp/setup">
    Connect an MCP client to her 14 hosted tools in one line.
  </Card>
</CardGroup>
