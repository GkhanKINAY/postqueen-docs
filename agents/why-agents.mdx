...
<Tip>
Prefer tool calls to shell commands? Her hosted MCP server hands you the same capabilities as 11 tools, with no local install. Setup: [MCP setup](/mcp/setup).
</Tip>
