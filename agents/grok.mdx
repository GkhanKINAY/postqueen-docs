...
- **Grok on the web, iOS and Android.** Add PostQueen as a custom connector at [grok.com/connectors](https://grok.com/connectors).
- **Grok Bot.** Enable that same connector under the Bot's Plugins. There is no second MCP URL.
...
<CardGroup cols={2}>
  <Card title="Grok setup over MCP" icon="/images/brand/icon-grok.svg" href="/mcp/clients/grok">
    Custom connector, Grok Bot plugins, and why the URL must be public
  </Card>
