...
<AccordionGroup>
  ...
  <Accordion title="What can she actually do from a ChatGPT chat?">
    Everything her 14 MCP tools cover, if your ChatGPT plan is allowed to call write tools. Listing channels is a read. Scheduling a post is a write (`integrationSchedulePostTool`). OpenAI currently documents full write MCP for Business and Enterprise/Edu; Plus and Pro may connect but only get read/fetch.
  </Accordion>
