...
ChatGPT reaches her over MCP. Turn on **Developer mode**, then add a plugin with one URL, and she becomes a tool the model can call:
...
<AccordionGroup>
  ...
  <Accordion title="What can she actually do from a ChatGPT chat?">
    Everything her 14 MCP tools cover. She can list your channels and read what each one accepts, and she can generate images, upload media and schedule posts across your 30+ networks.
  </Accordion>
