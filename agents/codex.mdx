...
<Steps>
  ...
  <Step title="Export your API key">
    Your key lives in the app at [app.postqueen.ai](https://app.postqueen.ai): open **Settings → API Keys** and click **Reveal**. Export it in the environment Codex runs in:
